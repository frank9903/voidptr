...
Xwindow::Xwindow(int width, int height): width(width), height(height) {
	...
	gc = XCreateGC(d, pix, 0, 0);
  	...
  	// Set up colours.
	const size_t numColours = 16;
  	XColor xcolour;
  	Colormap cmap;
  	char color_vals[numColours][20] = {"black", "papayawhip", "brown", "tomato", "darkorange", "lightsalmon", "yellowgreen", "powderblue", "cadetblue", "darkslategray", "grey19", "whitesmoke", "pink2", "lightskyblue3", "steelblue", "mediumpurple3"};
